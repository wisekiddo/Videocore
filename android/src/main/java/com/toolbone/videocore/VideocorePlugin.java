...
package com.toolbone.videocore;
...
public class VideocorePlugin implements MethodCallHandler {
  ...
  public static void registerWith(Registrar registrar) {
    final VideocorePlugin plugin = new VideocorePlugin(registrar);
    final MethodChannel channel =
        new MethodChannel(registrar.messenger(), "videocore");
  ...
  private VideocorePlugin(Registrar registrar) {
      ...
      case "create":
        {
          ...
          EventChannel eventChannel =
              new EventChannel(
                  registrar.messenger(), "videocore/videoEvents" + handle.id());
