...
final MethodChannel _channel = const MethodChannel('videocore')
...
///
/// The video is displayed in a Flutter app by creating a [Videocore] widget.
///
...
class VideoPlayerController extends ValueNotifier<VideoPlayerValue> {
  ...
  EventChannel _eventChannelFor(int textureId) {
    return EventChannel('videocore/videoEvents$textureId');
  }
...
class Videocore extends StatefulWidget {
  Videocore(this.controller);

  static const MethodChannel _channel =
  const MethodChannel('videocore');
  ...
  @override
  _VideocoreState createState() => _VideocoreState();
}

class _VideocoreState extends State<Videocore> {
  _VideocoreState() {
    _listener = () {
  ...
  @override
  void didUpdateWidget(Videocore oldWidget) {
